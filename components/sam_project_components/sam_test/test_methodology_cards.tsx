  ...
  return (
    <div>
      <div className='grid grid-cols-1 sm:grid-cols-2 gap-10 mt-2 mb-6'>
        <div>
          <div className='flex'>
            ...
            <p className="ml-5 leading-relaxed text-xl text-justify"><span className='font-bold'>Relevance: </span>
          ...
          <div className='flex mt-3 '>
            ...
            <p className="ml-5 leading-relaxed text-xl text-justify"><span className='font-bold'>Completeness: </span>
        ...
        <div>
          <div className='flex mt-2'>
            ...
            <p className="ml-5 leading-relaxed text-xl"><span className='font-bold'>Language: </span>
          ...
          <div className='flex'>
            ...
            <p className="ml-5 leading-relaxed text-xl text-justify"><span className='font-bold'>Number of words: </span>
          ...
          <div className='flex mt-3'>
            ...
            <p className="ml-5 leading-relaxed text-xl text-justify"><span className='font-bold'>Topic: </span>
      ...
      <div className='flex'>
        ...
        <p className="ml-5 leading-relaxed text-xl text-justify"><span className='font-bold'>Type of error: </span> <br></br> 
