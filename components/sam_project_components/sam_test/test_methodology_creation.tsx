...
export default function MethodologyCreation() {
  return (
    <div>
        <h3 className='text-2xl font-semibold mt-8 mb-3'>Creating the methodology</h3>
        {/**Creation of Annotation Scripts */}
        <p className='leading-relaxed text-xl text-violet-950 font-bold'>Creation of Annotation Scripts</p>
        <div className='grid grid-cols-1 sm:grid-cols-2 gap-10 mt-2 mb-6 text-justify'>
            <div>
                <p className='leading-relaxed text-xl'><span className='font-medium'>Objective: </span>
                Develop scripts to manipulate and format data, enabling the creation of a structured annotation system.</p>
            </div>
            <div>
                <p className='leading-relaxed text-xl'><span className='font-medium'>Implementation: </span>
        ...
        <p className='leading-relaxed text-xl  text-violet-950 font-bold'>Generation of Analytical Reports</p>
        <div className='grid grid-cols-1 sm:grid-cols-2 gap-10 mt-2 mb-6 text-justify'>
            <div>
                <p className='leading-relaxed text-xl'><span className='font-medium'>Objective: </span>
          ...
          <p className='leading-relaxed text-xl  text-violet-950 font-bold'>Manual Annotation and Systematization</p>
        <div className='grid grid-cols-1 sm:grid-cols-2 gap-10 mt-2 mb-6 text-justify'>
            <div>
                <p className='leading-relaxed text-xl'><span className='font-bold'>Initial Phase </span></p>
                <p className='leading-relaxed text-xl'><span className='font-medium'>Method: </span>
                ...
                <p className='leading-relaxed text-xl'><span className='font-medium'>Outcome: </span>
                Gain a thorough understanding of the data and refine the evaluation methodology.</p>
            </div>
            <div>
                <p className='leading-relaxed text-xl'><span className='font-bold'>Systematized Phase </span></p>
                <p className='leading-relaxed text-xl'><span className='font-medium'>Method: </span>
