...
export default function UserFlowsPartTwo() {
  return (
    <div>
      ...
      <h4 className='text-2xl font-semibold text-center my-5'>Non-Generative</h4>
      ...
      <h4 className='text-2xl font-semibold text-center my-5'>Generative</h4>
      <div className='grid grid-cols-1 sm:grid-cols-2 gap-10'>
        <div>
          <p className='my-3 leading-relaxed text-justify text-xl'> 
      ...
      <h4 className=' text-center text-2xl font-semibold mt-10'>Form vs. Substance</h4>
