...
export default function SystemPrompt() {
  return (
    <div>
      <h2 className='sm:text-2xl font-semibold'>Getting ready</h2>
      ...
      <div>
        <div className='flex'>
          ...
          <p className="ml-5 leading-relaxed sm:text-xl text-justify"><span className='font-bold'>Initial training: </span>
        ...
        <div className='flex mt-3 '>
          ...
          <p className="ml-5 leading-relaxed sm:text-xl text-justify"><span className='font-bold'>Understanding key concepts: </span>
