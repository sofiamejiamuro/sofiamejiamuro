...
export default function SamDefine() {
  ...
  return (
    ...
    id="define">
    <h1 className='text-3xl font-semibold mb-10'>Define</h1>
    <h2 className='text-2xl font-semibold'> User Persona</h2>
    ...
    <h2 className='text-2xl font-semibold mt-7'> How to address these profiles </h2>
    <ul className='
    ...
    <h2 className='text-2xl font-semibold mt-7'> Topics Mapping </h2>
    <p className='my-3 leading-relaxed text-justify text-xl'>
