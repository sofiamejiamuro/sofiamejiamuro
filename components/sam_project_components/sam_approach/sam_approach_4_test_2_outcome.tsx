  ...
  return (
    ...
    id="prototype">
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 gap-10'>
            ...
            <div>
                <h2 className='text-2xl font-semibold'> What insights emerged?</h2>
                <ul className='
                ...
                <p className='my-3 leading-relaxed text-justify text-xl'>These insights guided us in refining the functionality of the bot and user experience, aligning it more closely with user expectations and device capabilities.</p>
            </div>
        </div>
