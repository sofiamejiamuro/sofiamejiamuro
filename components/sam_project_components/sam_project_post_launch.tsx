...
export default function PostLaunch() {
  ...
  return (
    ...
    >
      ...
      <div className='
          mx-10 text-neutral-950 
          place-content-center px-10 m'>
        <p className='my-7 leading-relaxed text-justify text-xl'>
        ...
        <p className='leading-relaxed text-justify text-xl'>There was a clear need for a welcome message to help users understand how SAM could assist them. Despite this, stakeholders decided against adding the message.</p>

        <p className='leading-relaxed text-justify text-xl mt-5'> 
        <span className='font-bold'>3. Enhanced Visual Aids for Navigation:</span></p>
        <p className='leading-relaxed text-justify text-xl'>Users required more visual aids to better navigate the site. Heatmap data revealed that users were searching the entire site for clickable elements, indicating confusion about navigation.</p>
        <p className='leading-relaxed text-justify text-xl'>Future Actions: This behavior was anticipated, and thus, it highlighted the need for improved visual guidance.</p>
