    ...
    >
      ...
      <div className='mt-10 ' > 
        ...
        <div className='
          ...
          place-content-center px-10'>
          <h1 className='text-3xl font-semibold mb-10'>Goals</h1>
          <ul className='mt-2 leading-relaxed text-justify text-xl  list-disc list-inside'>
        ...
        {/** PROBLEM */}
        <div className='
          rounded-lg mx-12 text-neutral-950 
          p-10
        '>
          <h1 className='text-3xl font-semibold mb-10'>Problem</h1>
          <div className='grid grid-cols-1 sm:grid-cols-2 gap-10'>
            ...
            <div className='place-content-center'>
              <ul className='
                mt-2 leading-relaxed text-justify text-xl 
        ...
        <div className='
          ...
          <h1 className='text-3xl font-semibold mb-10'>How</h1>
          <p className='mt-2 leading-relaxed text-justify text-xl'>
