...
export default function SamConclusions() {
  return (
    ...
    className="
      ...
      "
    >  
      <div className='grid grid-cols-1 sm:grid-cols-3 gap-10 mt-20 px-24'>
        {/**LESSONS LEARNED */}
        <div >
          ...
          <h2 className='text-2xl font-semibold text-center mt-4'>LESSONS LEARNED</h2>
          <ul className='
          leading-relaxed text-justify text-xl 
        ...
        <div>
          ...
          <h2 className='text-2xl font-semibold text-center mt-4'>FUTURE IMPROVEMENTS</h2>
          <ul className='
          leading-relaxed text-justify text-xl 
        ...
        <div>
          ...
          <h2 className='text-2xl font-semibold  text-center mt-4'>FINAL THOUGHTS</h2>
          <ul className='
          leading-relaxed text-justify text-xl 
          list-none list-inside my-3'>
