...
type ResourceProps = (typeof resourcesData_2)[number];

export default function Resource_2({
  title,
  description,
  tags,
  imageUrl,
      ...
      <section className="
        ...
        >
            ...
            <ul className="flex flex-wrap mt-4 gap-2 sm:mt-auto">
                ...
                <li
                    className="
                    bg-violet-500 bg-opacity-70 px-3 py-1 text-[0.7rem] uppercase tracking-wider 
